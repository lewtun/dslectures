...
__all__ = ['get_dataset', 'rmse', 'convert_strings_to_categories', 'fill_missing_values_with_median',
           'get_polynomial_data', 'PolyFit', 'display_large', 'rf_feature_importance', 'plot_feature_importance',
           'plot_dendogram']
...
# Cell
def get_polynomial_data(w, n_samples=100, seed=42):
    """
    Creates noisy polynomial data.

    Args:
        w (array): polynomial weights in descending order
    ...
    y_data = y_true + np.random.randn(n_samples)
